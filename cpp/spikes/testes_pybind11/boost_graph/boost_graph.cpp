...
g++ -O3 -Wall -shared -std=c++14 -I../../testes_aboria/Aboria/src -I../../testes_aboria/Aboria/third-party -I../pybind11/include -fPIC `python-config --includes` -DABORIA_LOG_LEVEL=1 boost_graph.cpp -o boost_graph.so

python2 main_boost.py ../../../../python/graph_files/fcc.xyz 1.12 0 3 10
python2 -m cProfile -s time main_boost.py ../../../../python/graph_files/fcc.xyz 1.12 0 3 15 Y
python2 -m cProfile -s time main_boost.py ../../../../python/graph_files/fcc162.xyz 1.12 0 3 15 Y
python2 -m cProfile -s time main_boost.py ../../../../python/graph_files/fcc750.xyz 1.12 0 3 15 Y
